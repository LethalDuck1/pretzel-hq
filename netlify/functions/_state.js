...
// Supports legacy key header: x-admin-key
// Works even if you renamed env vars by checking common aliases.
// If no explicit key is set, ADMIN_PASSWORD also works as the legacy key (so you can't lock yourself out).
function _adminKey(){
  const key = _envAny([
    "ADMIN_KEY",
    "LEGACY_ADMIN_KEY",
